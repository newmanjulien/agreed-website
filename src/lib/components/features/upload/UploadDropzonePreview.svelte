...
<div class="flex h-full min-h-0 flex-col overflow-hidden bg-surface px-(--app-gutter)">
	<section class="mx-auto flex min-h-0 w-full max-w-[777px] flex-1 flex-col pt-7 text-center">
		<h1 class="text-[21.5px] leading-[1.22] tracking-[-0.02em] text-ink">
		...
		<button
			...
			class={[
				...
				highlighted ? 'bg-selection-highlight/28' : 'bg-canvas/40'
			]}
			tabindex="-1"
			aria-disabled="true"
		...
		>
			...
			<div class="relative flex flex-col items-center">
				...
				<span
					class="mt-[20px] inline-flex min-w-[92px] items-center justify-center rounded-full bg-accent px-[22px] py-[11px] text-[15.5px] text-white"
				>
					Start
				</span>
			</div>
