...
<svelte:head>
  <title>Agreed | Lets sales reps get deals signed themselves</title>
...
<main>
  ...
  <div class="flex flex-col gap-[150px] pt-[150px] sm:gap-[190px] sm:pt-[190px]">
    <FeatureSection title="Upload what the buyer changed">
      {#snippet body()}
    ...
    <FeatureSection title="Reps see what they can accept">
      {#snippet body()}
    ...
    <FeatureSection title="Reps know how to keep the deal moving">
      {#snippet body()}
